 ...
 * https://develnpm test ./test/01-strings-tests.jsoper.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String  *
 *                                                                                          *
 ********************************************************************************************/
...
function getRectangleString(width, height) {
    ...
    for (var i=1; i<=height; i++) {
        ...
        else if (i === height) { ans += '└' + '─'.repeat(width-2) + '┘\n' }
        else {ans += '│' + ' '.repeat(width-2) + '│\n' }
    }
    return ans
}
...
function encodeToRot13(str) {
    ...
    for (var i=0; i<str.length; i++) {
        if (lowalphabet.includes(str[i])) {
            ans = ans + lowalphabet[(lowalphabet.indexOf(str[i])+13)%26 ]
        }
        else if (upperalphabet.includes(str[i])) {
            ans = ans + upperalphabet[(upperalphabet.indexOf(str[i])+13)%26 ]
        }
        else { ans += str[i]}
    }
    return ans
